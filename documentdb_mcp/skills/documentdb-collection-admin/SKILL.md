...
description: >-
  ...
  databases and collections, and manage database users and their roles. Use when the
  agent must provision or tear down namespaces, enumerate the catalog, or administer
  auth principals. Do NOT use for reading/writing documents inside a collection (use
  documentdb-document-crud) or for aggregation/analytics (use
  documentdb-aggregation-analytics).
license: MIT
tags: [documentdb, mongodb, database, collection, admin, users, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---
