...
def get_skills_path() -> str:
    skills_dir = files("documentdb_mcp") / "skills"
...
def get_mcp_config_path() -> str:
    mcp_config_file = files("documentdb_mcp") / "mcp_config.json"
                ...
                try:
                    with open(skill_file, "r") as f:
                        ...
                        if content.startswith("---"):
                            ...
                            tag_name = skill_id.replace("documentdb-mcp-", "")
                            tags = ["documentdb-mcp", tag_name]
