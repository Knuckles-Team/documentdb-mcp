# documentdb-mcp — Concept Overview

> **Category**: Data | **Ecosystem Role**: MCP Server + A2A Agent
...
```json
{
  "mcpServers": {
    "documentdb-mcp": {
      "command": "uv",
      "args": ["run", "--with", "documentdb-mcp", "documentdb-mcp"],
      "env": {}
    }
  }
}
...
```bash
documentdb-mcp --transport streamable-http --port 8001
```
